...
export default function ItemCard({ m, onEdit, onDelete, onAdd, onRecipe, canAdd, canManage }) {
  ...
  return (
    <div 
      ...
      className={`relative flex flex-col bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden transition-all duration-200 h-full ${
      ...
      <div className="relative w-full aspect-square bg-slate-100 overflow-hidden">
        ...
        {finalImg && !imgError && (
          <img
            ...
            className={`w-full h-full object-cover transition-opacity duration-500 z-10 relative ${imageLoaded ? 'opacity-100' : 'opacity-0'}`}
          />
        )}
        ...
        {canManage && (
          <div className="absolute top-2 right-2 flex flex-col gap-2 z-30">
             ...
             <button 
                onClick={(e) => handleAction(e, onRecipe)}
